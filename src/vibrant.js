!function (t, r) {
  ...
  var r = function () {
    ...
    function s(r, n) {
      if (n.count()) {
        var o = n.r2 - n.r1 + 1, i = n.g2 - n.g1 + 1, u = t.max([o, i, n.b2 - n.b1 + 1]);
    ...
    return u.prototype = {
      volume: function (t) {
        ...
        var n = this.histo;
        if (!this._avg || t) {
          var o, i, u, a, s = 0, h = 1 << 8 - r, c = 0, f = 0, v = 0;
  ...
  return o.prototype.getColor = function (t, r) {
    ...
    var i = function (t) {
      ...
      return void 0 === n || Number.isInteger(n) ? n = 10 : n < 1 && (n = 10), {colorCount: r, quality: n}
    }({colorCount: o, quality: e}), u = new n(t), a = function (t, r, n) {
      ...
      return e
    }(u.getImageData().data, u.width * u.height, i.quality), s = r(a, i.colorCount);
    return s ? s.palette() : null
  }, o.prototype.getColorFromUrl = function (t, r, n) {
    var o = document.createElement("img"), e = this;
